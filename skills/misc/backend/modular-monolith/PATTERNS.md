...
See the detailed patterns below: examples, anti-patterns, and reference tables.

---

## Modular Monolith Patterns — Reference
...
For the WHEN/WHY of evolution stages (when to add API gateway, broker, cache layer), see [DECISIONS.md](DECISIONS.md).

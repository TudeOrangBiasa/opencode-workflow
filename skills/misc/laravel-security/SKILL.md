...
description: Use only when securing Laravel applications: authentication, authorization, CSRF, XSS prevention, SQL injection guards, encryption, and production security checklist.
---

# Laravel Security Best Practices

Adapted from ECC's `laravel-security` skill (MIT).

---
name: flox-environments-reference
description: Detailed reference for Flox Environments.
---

# Flox Environments — Reference
...
This makes Flox a natural fit for any workflow where OpenCode or other AI agents need to bootstrap project tooling on the fly.
...
The following skills are available as part of the [Flox OpenCode plugin](https://github.com/flox/flox-agentic) for deeper integration:

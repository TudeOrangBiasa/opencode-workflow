...
**Complementary: 1-4-9 rhythm.** 4pt is spacing granularity (alphabet). 1-4-9 is section rhythm (prose) — vary section spacing by 1×, 4×, or 9× the base unit. Use 4pt for intra-component gaps, 1-4-9 for inter-section rhythm. Both coexist; 4pt doesn't replace 1-4-9.

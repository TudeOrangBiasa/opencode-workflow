...
This is a starter template for the project's `design.md`. The `/agent-config` skill scaffolds this on first run (if frontend detected); agents (planner, builder, reviewer) read it before any UI work.
...
- This file is read by builder, reviewer, and advisor before any UI work
- Edit this file when adding new tokens or component patterns
- Reviewer uses this to judge taste/aesthetic, not generic "good UI"

 ...
 *   1. Check .design/live/config.json (returns config_missing if first-ever run)
...
Prepare everything for live variant mode in a single command:
  - Checks .design/live/config.json (required, created once per project)
...
The agent should then:
  ...
  // 4. Load PRODUCT.md + DESIGN.md context (auto-migrates legacy .design.md)

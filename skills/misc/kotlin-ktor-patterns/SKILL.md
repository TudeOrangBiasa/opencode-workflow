...
description: Use only when building Ktor applications: routes, plugins, content negotiation, authentication, serialization, and testing.
---

# Ktor Server Patterns

Adapted from ECC's `kotlin-ktor-patterns` skill (MIT).

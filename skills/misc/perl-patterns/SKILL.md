---
name: perl-patterns
description: Use only when writing Perl code — modern Perl conventions, Moose/Moo, error handling, testing with Test::More, and CPAN best practices.
---

# Modern Perl Development Patterns

Adapted from ECC's `perl-patterns` skill (MIT).

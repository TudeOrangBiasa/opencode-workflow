...
See [REFERENCE.md](REFERENCE.md) for full security checklist with code examples (secrets, input validation, SQL injection, auth, XSS, CSRF, rate limiting, data exposure, blockchain, dependencies) and security testing patterns.

...
- **[to-prd](./to-prd/SKILL.md)** — Turn the current conversation context into a PRD and publish it to the configured project issue tracker.
...
- **[eval-session](./eval-session/SKILL.md)** — Capture agent error patterns as evals, diagnose failures, self-heal workflow.

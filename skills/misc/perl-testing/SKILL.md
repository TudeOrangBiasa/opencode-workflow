---
name: perl-testing
description: Use only when writing Perl tests — Test::More, TAP, unit/integration tests, mocking with Test::MockModule, and CI integration.
---

# Perl Testing Patterns

Adapted from ECC's `perl-testing` skill (MIT).

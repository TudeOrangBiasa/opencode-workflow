...
description: Use only when using JetBrains Exposed ORM in Kotlin: table definitions, DSL queries, transactions, schema migrations, and DAO patterns.
---

# Kotlin Exposed Patterns

Adapted from ECC's `kotlin-exposed-patterns` skill (MIT).

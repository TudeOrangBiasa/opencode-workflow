...
**WARNING - AI SLOP TRAP**: Review ALL the DON'T guidelines from the parent design skill (already loaded in this context) before proceeding. Bold means distinctive, not "more effects."
...
When the result feels right, hand off to `{{command_prefix}}design polish` for the final pass.

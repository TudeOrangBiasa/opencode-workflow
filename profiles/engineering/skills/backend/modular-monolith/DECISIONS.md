...
- You know which stage you're in and need implementation details → use [PATTERNS.md](PATTERNS.md) (structure) or `backend-patterns` (general)
...
- [PATTERNS.md](PATTERNS.md) — *how* to structure a modular monolith (Client/Implementation, domain separation)
...
- See the stage-by-stage detail in the Reference section below.
...
- **Implementation patterns** for modular monolith (Client/Implementation, domain separation, ArchUnit) → see [PATTERNS.md](PATTERNS.md)

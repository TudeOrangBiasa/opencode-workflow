---
name: nuxt4-patterns
description: Use when nuxt 4 patterns for hydration safety, route rules, data fetching, and lazy loading. Use only when debugging hydration mismatches, configuring route rules, or writing SSR-safe data fetching in Nuxt 4 apps.
---

# Nuxt 4 Patterns

Adapted from ECC's `nuxt4-patterns` skill (MIT).

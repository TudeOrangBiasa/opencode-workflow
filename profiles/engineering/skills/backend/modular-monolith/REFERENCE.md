---
name: hexagonal-architecture-reference
description: Detailed reference for Hexagonal Architecture.
---
...
- **Inbound ports**: Contracts describing what the application can do (/use-case interfaces).
